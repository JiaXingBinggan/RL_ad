    ...
    for episode in range(config['train_episodes']):
        ...
        for t in range(96):
            ...
            print('第{}轮，第{}个时段，真实曝光数{}, 赢标数{}, 共获得{}个点击, 真实点击数{}, '
                  '利润{}, 预算{}, 花费{}, CPM{}, {}'
                  .format(episode + 1, t + 1, episode_imps, episode_win_imps, episode_clks, episode_real_clks, episode_reward, budget, episode_spent, episode_spent/episode_win_imps if episode_win_imps > 0 else 0, datetime.datetime.now()))
