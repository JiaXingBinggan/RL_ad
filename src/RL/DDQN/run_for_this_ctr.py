from src.RL.DDQN.env_one import AD_env
from src.RL.DDQN.RL_brain_one import DoubleDQN
import numpy as np
import pandas as pd
import copy
import datetime
...
if __name__ == '__main__':
    ...
    for i in range(len(budget_para)):
        ...
        print('########测试结果########\n')
        test_env(train_budget, config['test_auc_num'], budget_para[i], data_ctr_threshold)