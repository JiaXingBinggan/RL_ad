...
class PolicyGradientForTest:
    ...
    def restore_para(self, model_name):
        saver = tf.train.import_meta_graph('model_test/PG' + model_name + '_model.ckpt.meta')
        saver.restore(self.sess, 'model_test/PG' + model_name + '_model.ckpt')
        ...
        print(self.fc1_kernel,self.fc1_bias,self.fc2_kernel,self.fc2_bias)
